  ...
  return (
    <section id="contact" className="py-32 px-6 bg-card">
      <div className="max-w-2xl mx-auto text-center">
        <span className="text-sm uppercase tracking-widest text-muted-foreground mb-4 block">Современность</span>
        <h2 className="font-serif text-4xl md:text-5xl tracking-tight text-foreground mb-6 text-balance">
          От теории к практике
        </h2>
        <p className="text-muted-foreground text-lg mb-10 leading-relaxed">
          Труды российских тифлопедагогов живут в современных методиках. Хотите узнать больше или получить материалы по теме?
        </p>
        ...
        {submitted ? (
          <div className="p-8 rounded-2xl bg-sage/10 border border-sage/20">
            ...
            <p className="text-muted-foreground">Проверьте почту — мы пришлём полезные материалы.</p>
          </div>
        ) : (
